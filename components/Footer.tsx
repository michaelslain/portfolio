    ...
    return (
        <footer className="w-screen py-16 flex flex-col items-center gap-6 relative z-10">
            ...
            <div className="flex gap-8 flex-wrap justify-center">
                ...
                <Link href="https://www.linkedin.com/in/michaelslain/" target="_blank" rel="noopener noreferrer">
                    LinkedIn
                </Link>
                <Link href="#" onClick={handleEmailClick}>
                    {emailCopied ? 'Copied!' : 'Email'}
                </Link>
                <Link href="https://github.com/michaelslain" target="_blank" rel="noopener noreferrer">
                    GitHub
                </Link>
            </div>
        </footer>
