...
const BackgroundGrid: FC<BackgroundGridProps> = ({ spacing = 100, style, oddColumns = false }) => {
    const [dimensions, setDimensions] = useState({ cols: 0, rows: 0, actualSpacing: spacing })
    ...
    useEffect(() => {
        const updateDimensions = () => {
            ...
            if (oddColumns) {
                ...
                console.log('Grid lines:', cols, 'Columns (spaces):', cols - 1, 'Spacing:', actualSpacing)
            } else {
    ...
    return (
        <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-100" style={{ height: pageHeight }}>
